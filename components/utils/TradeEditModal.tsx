...
const TradeEditModal: React.FC<TradeEditModalProps> = ({
  ...
  const renderOpenTradeModal = () => {
    return (
      <>
        <div className="grid grid-cols-3 gap-4 mb-4">
          <label className="text-slate-200 text-left col-span-1">Ticker:</label>
          <input
            type="text"
        ...
        <div className="grid grid-cols-3 gap-4 mb-4">
          <span className="text-slate-200 text-left col-span-1 ">Action:</span>
          <select
        ...
        <div className="grid grid-cols-3 gap-4 mb-4">
          <label className="text-slate-200 text-left col-span-1">Strike:</label>
          <input
            type="text"
    ...
    <div className="modal modal-open">
      <div className="modal-box max-w-sm bg-slate-600 opacity-95">
        ...
        <div className="py-2 text-sm">
          {editedTrade.closedtradeid
            ? renderClosedTradeModal()
            : renderOpenTradeModal()}
        </div>
      </div>
    </div>
  );
