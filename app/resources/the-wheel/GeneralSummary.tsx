  ...
  return (
    <div className="collapse collapse-plus bg-[#002f00] bg-opacity-70">
      ...
      <div className="collapse-content text-sm space-y-2">
        ...
        <div className="text-lg font-medium text-slate-200">Strategy:</div>
        <p>
        ...
        <div className="text-lg font-medium text-slate-200">How to Trade:</div>
        <p>
        ...
        <div className="text-lg font-medium text-slate-200">Key Points:</div>
